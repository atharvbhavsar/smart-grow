    ...
    <main className="min-h-screen bg-white font-sans text-slate-900 pt-28 pb-28">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mb-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <Link 
            href="/services" 
            className="inline-flex items-center gap-2 text-xs font-extrabold uppercase tracking-widest text-slate-500 hover:text-blue-600 bg-slate-50 hover:bg-blue-50 px-4 py-2.5 rounded-full transition-all border border-slate-200/60 w-fit"
          >
